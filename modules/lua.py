# Taken from https://github.com/leafvmaple/luadata/tree/master/luadata/serializer
# Includes fix for https://github.com/leafvmaple/luadata/issues/7, from 
# https://github.com/leafvmaple/luadata/pull/9. This issue was a blocking problem
# for our use case. Since the patch PR is not merged, and the lib is licensed/portable, we copy.
# If the PR is merged in the future, we can remove this and use the luadata library normally.
